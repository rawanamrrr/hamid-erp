...
POLICY_GROUPS = {
    ...
    'backups':   'النسخ الاحتياطي التلقائي',
}
...
POLICY_REGISTRY = {
    ...
    'backups.daily_enabled': dict(
        group='backups', type='bool', default=True,
        label='نسخة احتياطية يومية تلقائية',
        help='ينشئ البرنامج نسخة كاملة من قاعدة البيانات مرة واحدة كل يوم في الموعد المحدد أدناه، بدون أي تدخل. إذا كان البرنامج مغلقاً وقت الموعد، تُؤخذ النسخة أول ما يُفتح في نفس اليوم.'),
    'backups.daily_time': dict(
        group='backups', type='time', default='02:00',
        label='موعد النسخة اليومية',
        help='اختر وقتاً يكون المحل فيه هادئاً — أخذ النسخة يستغرق ثوانيَ ويقرأ من قاعدة البيانات أثناء عمل البرنامج.'),
    'backups.folder': dict(
        group='backups', type='path', default='',
        label='مكان حفظ النسخ الاحتياطية',
        help='المسار الكامل للمجلد الذي تُحفظ فيه النسخ، مثل D:\\DigiFlow-Backups — يُفضّل قرص أو مكان غير القرص الذي عليه البرنامج. اتركه فارغاً لحفظها داخل مجلد بيانات البرنامج.'),
    'backups.keep_count': dict(
        group='backups', type='int', default=30,
        label='عدد النسخ المحفوظة',
        help='يحتفظ البرنامج بأحدث هذا العدد من النسخ ويحذف الأقدم تلقائياً حتى لا يمتلئ القرص. 30 نسخة ≈ شهر.'),
